  ...
  return (
    <section className="leadership">
      ...
      <div className="leadership-container">
        ...
        <div className="leadership-card">
          <img src={`${process.env.PUBLIC_URL}/images/leadership/uiuxdesigner.png`} alt="" />
        ...
        <div className="leadership-card">
          <img src={`${process.env.PUBLIC_URL}/images/leadership/androidDeveloper.png`} alt="" />
        ...
        <div className="leadership-card">
          <img src={`${process.env.PUBLIC_URL}/images/leadership/HR.jpg`} alt="" />
          <h2>Frontend Developer</h2>
